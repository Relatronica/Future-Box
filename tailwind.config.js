  ...
  theme: {
    extend: {
      colors: {
        ...
        'future-primary': '#4F46E5', // Deep indigo
        'future-primary-light': '#818CF8', // Lighter indigo
        'future-secondary': '#10B981', // Emerald
        'future-secondary-light': '#34D399', // Light emerald
        'future-accent': '#8B5CF6', // Violet
        'future-accent-light': '#A78BFA', // Light violet
        'future-dark': '#111827', // Nearly black
        'future-dark-blue': '#1E293B', // Dark blue-gray
        'future-light': '#F8FAFC', // Very light gray-blue
        'future-light-blue': '#EFF6FF', // Light blue
        'future-warning': '#F59E0B', // Amber
        'future-error': '#EF4444', // Red
      },
      fontFamily: {
